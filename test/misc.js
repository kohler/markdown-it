...
describe('HotCRP', function () {
  ...
  it('Should not create emphasis starting with a close bracket', function () {
    assert.strictEqual(
      md.render('(*) "Due to lack of knowledge of traffic patterns ..." To solve this,\
 I would recommend reading IMC\'09 paper from Srikanth Kandula\n(*) Another topology\
 to concern is the InternetZoo topology.'),
      '<p>(*) &quot;Due to lack of knowledge of traffic patterns ...&quot; To solve this,\
 I would recommend reading IMC\'09 paper from Srikanth Kandula\n(*) Another topology\
